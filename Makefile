...
.PHONY: build-x86_64
build-x86_64: $(kernel_c_object_files) $(x86_64_object_files) $(drivers_c_object_files) $(src_object_files)
	mkdir -p dist/x86_64
	x86_64-elf-ld -n -o dist/x86_64/kernel.bin -T targets/x86_64/linker.ld \
		$(kernel_c_object_files) $(x86_64_object_files) $(drivers_c_object_files) $(src_object_files)
